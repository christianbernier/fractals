 ...
 */
package com.fractal.compute.cltest;
...
import static com.fractal.compute.cltest.CLGLInteropDemo.*;
...
public class KernelTest {
    ...
    public KernelTest(long platform, CLCapabilities platformCaps, GLFWWindow window, int deviceType) { //boolean debugGL, int maxIterations
    ...
    void renderLoop() {
        ...
        while (!glfwWindowShouldClose(window.handle)) {
            ...
            glfwPollEvents();
            if (window != null && window.signal.getCount() == 0) {
                window.destroy();
                //window = null;
            }
        }
    ...
    private void computeCL(boolean is64bit) {
        ...
        /*if (!is64bit || !isDoubleFPAvailable(deviceCaps)) {
            clSetKernelArg1f(clKernel, 3, (float)-1);   	//px
            clSetKernelArg1f(clKernel, 4, (float)-1);		//py
            clSetKernelArg1f(clKernel, 5, (float)-1);		//pz
            clSetKernelArg1f(clKernel, 6, (float)1);//pitch Math.PI/4
            clSetKernelArg1f(clKernel, 7, (float)1);//yaw Math.PI/4
        } else {
        	clSetKernelArg1d(clKernel, 3, (double)-1);   	//px
            clSetKernelArg1d(clKernel, 4, (double)-1);		//py
            clSetKernelArg1d(clKernel, 5, (double)-1);		//pz
            clSetKernelArg1d(clKernel, 6, (double)1);//pitch Math.PI/4
            clSetKernelArg1d(clKernel, 7, (double)1);//yaw Math.PI/4
        }*/
    ...
    private void setKernelConstants() {
    	//clSetKernelArg1i(clKernel, 2, 60);
