...
public final class CLGLInteropDemo {
    ...
    public static void main(String... args) {
        ...
        int deviceType = !hasGPU ? CL_DEVICE_TYPE_CPU : CL_DEVICE_TYPE_GPU;
        ...
        //glfwSetWindowPos(window.handle, 200, 200);
        ...
        KernelTest demo = null;
        try {
            //demo = new Mandelbrot(platform, platformCaps, window, deviceType); //, false, maxIterations
        	demo = new KernelTest(platform, platformCaps, window, deviceType);
        } catch (Exception e) {
            e.printStackTrace();
        }
